...
export function createConnectPage(
  ...
  function buildRoot(): HTMLDivElement {
    ...
    // RY logo branding — prepended to server panel
    ...
    logoSvg.setAttribute("class", "ry-logo");

    const defs = document.createElementNS("http://www.w3.org/2000/svg", "defs");
    const grad = document.createElementNS("http://www.w3.org/2000/svg", "linearGradient");
    grad.setAttribute("id", "ry-grad");
    ...
    filter.setAttribute("id", "ry-glow");
    ...
    glowText.setAttribute("fill", "url(#ry-grad)");
    glowText.setAttribute("letter-spacing", "-4");
    glowText.setAttribute("opacity", "0.4");
    glowText.setAttribute("filter", "url(#ry-glow)");
    glowText.setAttribute("class", "ry-glow-layer");
    glowText.textContent = "RY";
    ...
    sharpText.setAttribute("fill", "url(#ry-grad)");
    sharpText.setAttribute("letter-spacing", "-4");
    sharpText.textContent = "RY";
    logoSvg.appendChild(sharpText);

    branding.appendChild(logoSvg);

    const brandName = createElement("div", { class: "brand-name" }, "Rylo");
