...
const STORAGE_KEY_ACTIVE = "rylo:theme:active";
const STORAGE_KEY_LEGACY = "rylo:settings:theme";
const STORAGE_KEY_CUSTOM_PREFIX = "rylo:theme:custom:";

export interface RyloTheme {
...
export function saveCustomTheme(theme: RyloTheme): void {
...
export function loadCustomTheme(name: string): RyloTheme | null {
...
export function exportTheme(theme: RyloTheme): string {
...
export function restoreTheme(): void {
  ...
  try {
    const raw = localStorage.getItem("rylo:settings:accentColor");
    if (raw !== null) {
