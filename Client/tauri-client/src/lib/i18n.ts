const EXACT_TEXT: Record<string, string> = {
  ...
  "Admin code is required for the admin email.": "Для админской почты обязателен админ-код.",
  "Invite code is required unless you use the admin email.": "Код приглашения обязателен, если вы не используете админскую почту.",
  "Requesting...": "Отправка...",
  ...
  "username and password are required": "Имя пользователя и пароль обязательны",
  "invite_code is required unless you register with the admin email": "Код приглашения обязателен, если вы не регистрируетесь с админской почтой",
  "admin_code is required for the admin email": "Для админской почты обязателен админ-код",
