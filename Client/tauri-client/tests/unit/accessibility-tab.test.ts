...
describe("AccessibilityTab", () => {
  ...
  describe("restore from localStorage", () => {
    it("restores reducedMotion on from localStorage", () => {
      localStorage.setItem("rylo:settings:reducedMotion", "true");
    ...
    it("restores highContrast on from localStorage", () => {
      localStorage.setItem("rylo:settings:highContrast", "true");
    ...
    it("restores roleColors off from localStorage", () => {
      localStorage.setItem("rylo:settings:roleColors", "false");
    ...
    it("restores syncOsMotion on from localStorage", () => {
      localStorage.setItem("rylo:settings:syncOsMotion", "true");
    ...
    it("restores largeFont on from localStorage", () => {
      localStorage.setItem("rylo:settings:largeFont", "true");
  ...
  describe("toggle persistence", () => {
    it("persists reducedMotion to localStorage on toggle", () => {
      ...
      expect(localStorage.getItem("rylo:settings:reducedMotion")).toBe("true");

      clickToggle(container, 0);
      expect(localStorage.getItem("rylo:settings:reducedMotion")).toBe("false");
    });
    ...
    it("persists highContrast to localStorage on toggle", () => {
      ...
      expect(localStorage.getItem("rylo:settings:highContrast")).toBe("true");
    });
    ...
    it("persists roleColors to localStorage on toggle", () => {
      ...
      expect(localStorage.getItem("rylo:settings:roleColors")).toBe("false");
    });
    ...
    it("persists syncOsMotion to localStorage on toggle", () => {
      ...
      expect(localStorage.getItem("rylo:settings:syncOsMotion")).toBe("true");
    });
    ...
    it("persists largeFont to localStorage on toggle", () => {
      ...
      expect(localStorage.getItem("rylo:settings:largeFont")).toBe("true");
    });
  });
  ...
  // -----------------------------------------------------------------------
  // rylo:pref-change event
  // -----------------------------------------------------------------------

  describe("pref-change custom event", () => {
    it("dispatches rylo:pref-change event on toggle", () => {
      const section = buildAccessibilityTab(ac.signal);
      container.appendChild(section);

      const listener = vi.fn();
      window.addEventListener("rylo:pref-change", listener);
      ...
      window.removeEventListener("rylo:pref-change", listener);
    });
  });
});
