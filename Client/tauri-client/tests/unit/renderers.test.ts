...
describe("renderers", () => {
  ...
  describe("developer mode — Copy ID button", () => {
    it("renders Copy ID button when developerMode is enabled", () => {
      // loadPref reads from localStorage with the "rylo:settings:" prefix
      ...
      window.dispatchEvent(new CustomEvent("rylo:pref-change", {
      ...
      localStorage.setItem("rylo:settings:developerMode", "false");
      window.dispatchEvent(new CustomEvent("rylo:pref-change", {
        detail: { key: "developerMode" },
      }));
      ac.abort();
  ...
  describe("roleColorVar", () => {
    afterEach(() => {
      ...
      localStorage.setItem("rylo:settings:roleColors", "true");
      window.dispatchEvent(new CustomEvent("rylo:pref-change", {
