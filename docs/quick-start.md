...
Get Rylo up and running in minutes.
...
Get the latest release from GitHub Releases. Download `chatserver.exe` and the `Rylo` installer.
...
Friends install Rylo, enter your server address (IP or domain + port 8443), and redeem their invite code to register.
