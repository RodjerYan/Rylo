...
Production deployment guide for Rylo server on Windows.
...
# Create service
nssm install Rylo "C:\Rylo\chatserver.exe"
nssm set Rylo AppDirectory "C:\Rylo"
nssm set Rylo DisplayName "Rylo Chat Server"
nssm set Rylo Start SERVICE_AUTO_START
