...
// certs as Rylo (avoids mixed-content blocks in WebView2).
...
func (p *LiveKitProcess) generateConfig() (string, error) {
	...
	// No TURN TLS config — LiveKit signaling is proxied through Rylo's
	...
	content := fmt.Sprintf(`# Auto-generated by Rylo — do not edit manually.
port: 7880
