...
func newTestServer(t *testing.T, release ghRelease, statusCode int) *httptest.Server {
	...
	mux.HandleFunc("/repos/J3vb/Rylo/releases/latest", func(w http.ResponseWriter, r *http.Request) {
...
func newTestUpdater(baseURL, currentVersion string) *Updater {
	u := NewUpdater(currentVersion, "", "J3vb", "Rylo")
	u.baseURL = baseURL
	return u
}

func TestCheckForUpdate_NewerVersionAvailable(t *testing.T) {
	release := newTestRelease("v1.2.0", "Bug fixes and improvements", "https://github.com/J3vb/Rylo/releases/tag/v1.2.0",
		"https://github.com/J3vb/Rylo/releases/download/v1.2.0")
...
func TestCheckForUpdate_UpToDate(t *testing.T) {
	release := newTestRelease("v1.0.0", "Current release", "https://github.com/J3vb/Rylo/releases/tag/v1.0.0",
		"https://github.com/J3vb/Rylo/releases/download/v1.0.0")
	srv := newTestServer(t, release, http.StatusOK)
	defer srv.Close()
...
func TestCheckForUpdate_CachesResult(t *testing.T) {
	...
	release := newTestRelease("v2.0.0", "Major update", "https://github.com/J3vb/Rylo/releases/tag/v2.0.0",
		"https://github.com/J3vb/Rylo/releases/download/v2.0.0")
...
func TestValidateDownloadURL_Valid(t *testing.T) {
	u := NewUpdater("1.0.0", "", "J3vb", "Rylo")
	err := u.ValidateDownloadURL("https://github.com/J3vb/Rylo/releases/download/v1.0.0/chatserver.exe")
	if err != nil {
...
func TestFetchBody_WithGithubToken(t *testing.T) {
	...
	u := NewUpdater("1.0.0", "my-token", "J3vb", "Rylo")
	u.baseURL = srv.URL
...
func TestDownloadAndVerify_Success(t *testing.T) {
	...
	downloadURL := "https://github.com/J3vb/Rylo/releases/download/v1.0.0/chatserver.exe"
	checksumURL := "https://github.com/J3vb/Rylo/releases/download/v1.0.0/checksums.sha256"
