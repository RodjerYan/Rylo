...
func TestAdminAPI_CheckUpdate_OK(t *testing.T) {
	...
	mockGH := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		_ = json.NewEncoder(w).Encode(map[string]any{
			"tag_name": "v2.0.0",
			"body":     "New release",
			"html_url": "https://github.com/J3vb/Rylo/releases/tag/v2.0.0",
			"assets": []map[string]any{
				{"name": "chatserver.exe", "browser_download_url": "https://github.com/J3vb/Rylo/releases/download/v2.0.0/chatserver.exe"},
				{"name": "checksums.sha256", "browser_download_url": "https://github.com/J3vb/Rylo/releases/download/v2.0.0/checksums.sha256"},
			},
		})
	}))
	defer mockGH.Close()

	u := updater.NewUpdater("1.0.0", "", "J3vb", "Rylo")
...
func TestAdminAPI_CheckUpdate_UpToDate(t *testing.T) {
	mockGH := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		_ = json.NewEncoder(w).Encode(map[string]any{
			"tag_name": "v1.0.0",
			"body":     "",
			"html_url": "https://github.com/J3vb/Rylo/releases/tag/v1.0.0",
			"assets":   []map[string]any{},
		})
	}))
	defer mockGH.Close()
	...
	mockGH := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_ = json.NewEncoder(w).Encode(map[string]any{
			...
			"assets": []map[string]any{
				{
					"name":                 "chatserver.exe",
					"browser_download_url": "https://github.com/J3vb/Rylo/releases/download/v2.0.0/chatserver.exe",
				},
				{
					"name":                 "checksums.sha256",
					"browser_download_url": "https://github.com/J3vb/Rylo/releases/download/v2.0.0/checksums.sha256",
				},
			},
		})
