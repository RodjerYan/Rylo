...
<p align="center">
  <img src=".github/images/Client.png" alt="Rylo Client" width="700">
</p>
...
- RY Neon Glow theme with custom theming system (JSON import/export)
- Accent color picker
...
1. Download `chatserver.exe` and the Rylo installer from
   [GitHub Releases](https://github.com/J3vb/Rylo/releases)
...
| `server.name` | `Rylo Server` | Display name |
